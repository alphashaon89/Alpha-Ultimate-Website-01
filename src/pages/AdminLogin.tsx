...
export default function AdminLogin() {
  ...
  return (
    <div className="bg-[#070712] min-h-screen flex items-center justify-center px-4">
      ...
      <motion.div initial={{ opacity: 0, y: 20, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }}
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white" style={{fontFamily:'Syne,sans-serif'}}>Admin Access</h1>
